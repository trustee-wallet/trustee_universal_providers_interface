...
The **request headers** are transmitted by Trustee and should be checked on the exchanger side. The **response headers** are transmitted by exchanger and should be checked on the Trustee side.
...
API keys can generate any side (Trustee or exchanger) and then share them to the other side.
...
> first you need to share a API keys with the Trustee team
